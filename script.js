const products = [
  ...
  {id:4,name:"👼Versace Medusa Biggie Leather Belt",price:1299,img:"images/photo_2026-03-01_15-14-04.jpg",description:"<p>✨ Розмір: 105-110-115 см</p>  <p>🔒 Якість: 1:1 (преміум) Символ італійської розкоші та зухвалості. Ремінь, який стане головним акцентом вашого образу, додаючи йому впевненості та лоску.</p>  <p>🔥Легендарна пряжка з головою Medusa та преміальна шкіра з тисненням фірмового грецького орнаменту</p>"},
